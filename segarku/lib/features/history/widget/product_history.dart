...
import 'package:segarku/features/history/widget/order_detail_history/order_detail_history.dart';
...
@override
  Widget build(BuildContext context) {
    return Padding(
      ...
      child: GestureDetector( // Membungkus kontainer utama dengan GestureDetector
        onTap: () {
          Get.to(() => const OrderDetailHistoryScreen()); // Navigasi ke halaman OrderDetailHistoryScreen
        },
        child: Container(
