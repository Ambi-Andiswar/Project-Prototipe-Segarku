...
class _AddressPopupState extends State<AddressPopup> {
  ...
  // Fungsi untuk field dengan Autocomplete (hanya "Pilih Kelurahan")
  Widget _buildAutocompleteField(String label, TextEditingController controller, IconData icon, bool dark) {
    return Column(
  ...
  // Fungsi untuk field nomor telepon (hanya angka)
  ...
  // Fungsi untuk field biasa (tanpa rekomendasi)
  ...
  // Fungsi untuk dekorasi input (agar lebih rapi)
        ...
        child: SingleChildScrollView(
          ...
          child: Column(
            ...
            children: [
              ...
              _buildAutocompleteField("Pilih Kelurahan", _selectedAddressController, SIcons.location, dark),
              const SizedBox(height: SSizes.sm),
              _buildTextField("Detail Alamat", _addressDetail, SIcons.home, dark),
              const SizedBox(height: SSizes.sm),
